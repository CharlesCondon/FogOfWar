...
export default function CreateProfile(userId: string) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            await createNewUser(userId, name, units, selectedCountry).then(
                () => {
                    return router.push("/(app)/(tabs)"); // Navigate after successful setup
                }
            );
        } catch (error: any) {
